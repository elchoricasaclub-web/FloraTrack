...
export default function CertificacionesModule() {
  return (
    <ComplianceAuditShell
      eyebrow="FloraTrack RegTech"
      title="Certificaciones y Licencias"
      description="Control integral de certificaciones, licencias, acreditaciones, normas técnicas, evidencias, auditorías y vencimientos."
