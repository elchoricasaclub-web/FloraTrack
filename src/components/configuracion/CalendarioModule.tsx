    ...
    <section className="bg-white rounded-2xl shadow p-8">
      <div className="flex justify-between items-start gap-6 mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-2 max-w-xl">
            Calendario maestro de actividades GACP, GMP, cosechas, análisis, auditorías, capacitaciones, mantenimientos, vencimientos y compromisos regulatorios.
          </p>
        </div>
      ...
      <div className="border rounded-2xl p-12 text-center">
        ...
        <p className="text-slate-500 mt-3 max-w-md mx-auto">
          Registre eventos críticos para coordinar la operación agrícola, documental y regulatoria.
        </p>
      </div>
    </section>
  );
