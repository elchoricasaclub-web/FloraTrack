  ...
  return (
    <section className="bg-white rounded-2xl shadow p-8">
      <div className="flex justify-between items-start gap-6 mb-8">
        <div>
          <h2 className="text-4xl font-bold text-slate-800">Backups y Seguridad</h2>
          <p className="text-slate-500 mt-2 max-w-xl">
            Gestión de respaldo, recuperación, integridad de datos, auditoría de cambios, seguridad documental y continuidad operacional.
          </p>
        </div>
      ...
      <div className="border rounded-2xl p-12 text-center">
        ...
        <p className="text-slate-500 mt-3 max-w-md mx-auto">
          Configure copias de seguridad y controles de integridad para proteger la información crítica.
        </p>
      </div>
    </section>
  );
