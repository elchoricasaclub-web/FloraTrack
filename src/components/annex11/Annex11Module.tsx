...
export default function Annex11Module() {
  return (
    <DbCrudModule
      title="EU Annex 11"
      description="Controles EU GMP Annex 11 para sistemas computarizados: validación, seguridad, audit trail, disponibilidad, backup y gestión de cambios."
      apiPath="/api/compliance/controls"
      buttonLabel="Nuevo Control Annex 11"
      icon="🇪🇺"
      emptyForm={{
        id: "",
        code: "",
