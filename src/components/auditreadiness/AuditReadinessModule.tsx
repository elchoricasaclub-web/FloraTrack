...
export default function AuditReadinessModule() {
  return (
    <ComplianceAuditShell
      eyebrow="FloraTrack Audit Ready"
      title="Audit Readiness"
      description="Preparación para auditoría con evidencias, brechas, documentos, CAPA, responsables, vencimientos y score de cierre."
      createLabel="+ Nueva Evidencia"
      items={items}
    />
  );
}
