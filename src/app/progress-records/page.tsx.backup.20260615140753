  ...
  return (
    <main className="min-h-screen bg-slate-100 p-8">
      <section className="rounded-3xl bg-slate-950 p-8 text-white shadow">
        ...
        <a
          href="/"
          className="ml-3 inline-block rounded-2xl border border-white/20 px-6 py-4 font-black text-white"
        >
          Volver
        </a>
      </section>
