...
const dataFile = path.join(dataDir, "geneticas.json");
...
export async function POST(request: Request) {
  ...
  if (invalid(body.codigo)) missing.push("Código interno");
  if (invalid(body.nombre)) missing.push("Nombre de genética");
  if (invalid(body.tipo)) missing.push("Tipo");
  if (invalid(body.origen)) missing.push("Origen");
